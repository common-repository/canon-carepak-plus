...
<body>
  ...
  <div class="form-internal">
    ...
    <form method="post" action="" name="customapp" id="customapp" class="customapp" onchange="activeModule();">
      ...
      <div>
        <p>In order for the QuickCover® plugin to communicate with your QuickCover® account (to sync products, present plans, and to record sales and cancellations), please enter the API Key and Store ID from your QuickCover® account.
          ...
          <a href="https://signup.quickcover.me/join/afterinc" target="_blank">https://signup.quickcover.me/join/afterinc</a>
        </p>
      ...
      <div>
        <div class="form-group row">
          <label for="storeid" class="col-sm-2 col-form-label">Storeid</label>
          <div class="col-sm-10">
            <input type="text" class="form-control" id="storeid" name="storeid" value="<?php echo esc_attr($storeid); ?>" placeholder="storeid">
        ...
        ?>
        <button type="button" class="btn btn-success test test_auth" data-style="expand-left" id="testautentication" name="testautentication" style="margin-right: 4px !important">Test Authentication</button><span name="authmessage" id="authmessage" class='testauth font-weight-bold'><?php if (isset($current_date) || $current_date != "") {
                                                                                                                                                                                                echo $auth_message . " " . date("m/d/Y H:i:s", strtotime($current_date)) . "\n";
                                                                                                                                                                                               } ?></span>
      ...
      <div>
        <p>In order to present plans for eligible products, you need to sync your products with you QuickCover® account. If you have disabled Auto Product Sync, then you can sync here. This processing time is dependent on the number of products in the sync.</p>
      </div>
                 ...
                 <div id = "batchsyncstatus" class="syncstatus">
                    <ul class="mt-2 mb-2 printBatches">
                     ...
                     <li>Success Batch : <span id="successBatchPrint"><?php echo $getSuccess_batch; ?></span></li>
					  ...
					  <li class="displayTime">Last Synced Date : <span id="currentdateprint" ><?php echo $get_Latestdate; ?></span></li>
                    </ul>
             </div>
        </div> 
	<div class="buttons">
